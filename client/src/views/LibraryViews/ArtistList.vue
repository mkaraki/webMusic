...
onMounted(() => {
    addItemsRecursive(`/library/${libraryId}/artist`);
});
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="card-title cut-overflow card-album">
                            <RouterLink :to="`/library/${libraryId}/artist/${item['id']}`" class="list-group-item-action">
                                {{ item['dispName'] }}
                            </RouterLink>
                        </h5>
                        <p class="card-text card-artist cut-overflow">
                            <RouterLink :to="`/library/${libraryId}/album/${item['albumId']}`">
                                {{ item['albumTitle'] }}
                            </RouterLink> etc...
                        </p>
                    </div>
